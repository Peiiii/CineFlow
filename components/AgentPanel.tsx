  ...
  <div className="lov-hover-card bg-[#F4F4F5] rounded-[24px] px-5 py-4 flex justify-between items-center cursor-pointer group mb-3 shadow-sm">
    ...
    <div className="relative flex -space-x-4 flex-shrink-0">
      {images.map((img, i) => (
        <div 
          key={i} 
          className="w-[48px] h-[34px] rounded-[8px] border-[2px] border-white overflow-hidden shadow-sm transform transition-transform group-hover:-translate-y-1.5 group-hover:rotate-1"
          style={{ zIndex: 10 - i }}
        >
      ...
      <div className="px-8 pt-8 pb-3 flex items-center justify-end gap-2">
        {[
          ...
          <button key={i} className="lov-btn icon-center text-[#9A9A9A] hover:text-black hover:bg-[#F2F2F2] w-8 h-8 rounded-[10px]">
            <svg className="w-4 h-4 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d={d} /></svg>
          </button>
        ))}
      </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <button className="lov-btn icon-center text-[#9A9A9A] hover:bg-[#E8E8E8] hover:text-black w-9 h-9 rounded-[10px]">
                <svg className="w-5 h-5 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.2"><path d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l4.5-4.5" /></svg>
              </button>
              <button className="lov-btn icon-center text-[#9A9A9A] hover:bg-[#E8E8E8] hover:text-black w-9 h-9 rounded-[10px]">
